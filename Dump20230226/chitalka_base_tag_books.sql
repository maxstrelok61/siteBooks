...
CREATE TABLE `tag_books` (
  ...
  KEY `FKm71bc4vxs6kqcqdkm415ovmwd` (`books_id`),
  KEY `FKtmap9ughfowy06k5jkgb0wr50` (`tag_id`),
  CONSTRAINT `FKm71bc4vxs6kqcqdkm415ovmwd` FOREIGN KEY (`books_id`) REFERENCES `book` (`id`),
  CONSTRAINT `FKtmap9ughfowy06k5jkgb0wr50` FOREIGN KEY (`tag_id`) REFERENCES `tag` (`id`)
